...
import LeadProtectedRoute from "../compoenets/teamleadprotectedRoutes";
...
const Calender = () => {
  ...
  // console.log("meet", parsedtrainee);
    ...
    try {
      const response = await fetch("/api/submitMeeting", {
        ...
        body: JSON.stringify({
          ...
          user: user,
          userid: id,
          traineename: newEvent.trainee.name,
        }),
      });
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-filter backdrop-blur-md">
            <div className="bg-white w-96 p-6 rounded shadow-lg">
              ...
              <span className="mb-4 bg-slate-200 p-1">
                {parsedtrainee.name}
              </span>
